...
class NimEnv(ta.Env):
    ...
    def step(self, action: str) -> Tuple[bool, ta.Info]:
        ...
        self.state.add_observation(message="Updated piles:\n" + self._render_piles()) # After the current player moves, send the updated board to the opponent.
    ...
    def _execute_move(self, action: str) -> None:
        ...
        self.state.add_observation(message=f"Player {self.state.current_player_id} removes {quantity} from pile {pile_index}.") # Announce the move
