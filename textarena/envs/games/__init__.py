...
register(id="KuhnPoker-v0-train-long", entry_point="textarena.envs.games.KuhnPoker.env:KuhnPokerEnv", default_wrappers=[GameMessagesAndCurrentBoardObservationWrapper, ActionFormattingWrapper], ante=1, max_rounds=9)
register(id="KuhnPoker-v0-train-blind", entry_point="textarena.envs.games.KuhnPoker.env:KuhnPokerEnv", default_wrappers=[GameMessagesAndCurrentBoardObservationWrapper, ActionFormattingWrapper], ante=1, max_rounds=5)
register(id="KuhnPoker-v0-train-highstakes", entry_point="textarena.envs.games.KuhnPoker.env:KuhnPokerEnv", default_wrappers=[GameMessagesAndCurrentBoardObservationWrapper, ActionFormattingWrapper], ante=5, max_rounds=5)
register(id="KuhnPoker-v0-train-extended", entry_point="textarena.envs.games.KuhnPoker.env:KuhnPokerEnv", default_wrappers=[GameMessagesAndCurrentBoardObservationWrapper, ActionFormattingWrapper], ante=1, max_rounds=15)
