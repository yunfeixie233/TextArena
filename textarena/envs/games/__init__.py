...
register(id="Crosswords-v0", entry_point="textarena.envs.games.Crosswords.env:CrosswordsEnv", default_wrappers=[LLMObservationWrapper], hardcore=False, max_turns=30, num_words=3)
register(id="Crosswords-v0-hardcore", entry_point="textarena.envs.games.Crosswords.env:CrosswordsEnv", default_wrappers=[LLMObservationWrapper], hardcore=True, max_turns=30, num_words=3)
...
register(id="ConnectFour-v0", entry_point="textarena.envs.games.ConnectFour.env:ConnectFourEnv", default_wrappers=[LLMObservationWrapper], is_open=True, num_rows=6, num_cols=7)
register(id="ConnectFour-v0-blind", entry_point="textarena.envs.games.ConnectFour.env:ConnectFourEnv", default_wrappers=[LLMObservationWrapper], is_open=False, num_rows=6, num_cols=7)
register(id="ConnectFour-v0-large", entry_point="textarena.envs.games.ConnectFour.env:ConnectFourEnv", default_wrappers=[LLMObservationWrapper], is_open=True, num_rows=12, num_cols=15)
...
register(id="KuhnPoker-v0", entry_point="textarena.envs.games.KuhnPoker.env:KuhnPokerEnv", default_wrappers=[LLMObservationWrapper], ante=1, max_rounds=10)
register(id="KuhnPoker-v0-long", entry_point="textarena.envs.games.KuhnPoker.env:KuhnPokerEnv", default_wrappers=[LLMObservationWrapper], ante=1, max_rounds=15)
register(id="KuhnPoker-v0-blind", entry_point="textarena.envs.games.KuhnPoker.env:KuhnPokerEnv", default_wrappers=[LLMObservationWrapper], ante=1, max_rounds=10)
register(id="KuhnPoker-v0-highstakes", entry_point="textarena.envs.games.KuhnPoker.env:KuhnPokerEnv", default_wrappers=[LLMObservationWrapper], ante=5, max_rounds=10)
register(id="KuhnPoker-v0-extended", entry_point="textarena.envs.games.KuhnPoker.env:KuhnPokerEnv", default_wrappers=[LLMObservationWrapper], ante=1, max_rounds=30)
...
# Nim (two-player)
register(id="Nim-v0", entry_point="textarena.envs.games.Nim.env:NimEnv", default_wrappers=[LLMObservationWrapper], piles=[3, 4, 5])
register(id="Nim-v0-small", entry_point="textarena.envs.games.Nim.env:NimEnv", default_wrappers=[LLMObservationWrapper], piles=[1, 2, 3])
register(id="Nim-v0-large", entry_point="textarena.envs.games.Nim.env:NimEnv", default_wrappers=[LLMObservationWrapper], piles=[5, 7, 9])
...
register(id="Othello-v0", entry_point="textarena.envs.games.Othello.env:OthelloEnv", default_wrappers=[LLMObservationWrapper], show_valid=True)
register(id="Othello-v0-tiny", entry_point="textarena.envs.games.Othello.env:OthelloEnv", default_wrappers=[LLMObservationWrapper], board_size=4, show_valid=True)
register(id="Othello-v0-small", entry_point="textarena.envs.games.Othello.env:OthelloEnv", default_wrappers=[LLMObservationWrapper], board_size=6, show_valid=True)
register(id="Othello-v0-big", entry_point="textarena.envs.games.Othello.env:OthelloEnv", default_wrappers=[LLMObservationWrapper], board_size=10, show_valid=True)
register(id="Othello-v0-huge", entry_point="textarena.envs.games.Othello.env:OthelloEnv", default_wrappers=[LLMObservationWrapper], board_size=14, show_valid=True)
register(id="Othello-v0-hard", entry_point="textarena.envs.games.Othello.env:OthelloEnv", default_wrappers=[LLMObservationWrapper], show_valid=False)
...
# Pig (two-player)
register(id="PigDice-v0", entry_point="textarena.envs.games.PigDice.env:PigDiceEnv", default_wrappers=[LLMObservationWrapper], winning_score=100, max_turns=100)
register(id="PigDice-v0-short", entry_point="textarena.envs.games.PigDice.env:PigDiceEnv", default_wrappers=[LLMObservationWrapper], winning_score=50, max_turns=50)
register(id="PigDice-v0-long", entry_point="textarena.envs.games.PigDice.env:PigDiceEnv", default_wrappers=[LLMObservationWrapper], winning_score=500, max_turns=500)
...
register(id="SpellingBee-v0", entry_point="textarena.envs.games.SpellingBee.env:SpellingBeeEnv", default_wrappers=[LLMObservationWrapper], num_letters=7)
register(id="SpellingBee-v0-small", entry_point="textarena.envs.games.SpellingBee.env:SpellingBeeEnv", default_wrappers=[LLMObservationWrapper], num_letters=4)
register(id="SpellingBee-v0-large", entry_point="textarena.envs.games.SpellingBee.env:SpellingBeeEnv", default_wrappers=[LLMObservationWrapper], num_letters=10)
...
register(id="TicTacToe-v0", entry_point="textarena.envs.games.TicTacToe.env:TicTacToeEnv", default_wrappers=[LLMObservationWrapper])
...
register(id="ReverseTicTacToe-v0", entry_point="textarena.envs.games.ReverseTicTacToe.env:ReverseTicTacToeEnv", default_wrappers=[LLMObservationWrapper])
...
register(id="RandomizedTicTacToe-v0", entry_point="textarena.envs.games.RandomizedTicTacToe.env:RandomizedTicTacToeEnv", default_wrappers=[LLMObservationWrapper])
...
register(id="IteratedRockPaperScissors-v0", entry_point="textarena.envs.games.IteratedRockPaperScissors.env:IteratedRockPaperScissorsEnv", default_wrappers=[LLMObservationWrapper], num_rounds=10)
...
register(id="SimpleTak-v0", entry_point="textarena.envs.games.SimpleTak.env:SimpleTakEnv", default_wrappers=[LLMObservationWrapper], board_size=4)
register(id="SimpleTak-v0-medium", entry_point="textarena.envs.games.SimpleTak.env:SimpleTakEnv", default_wrappers=[LLMObservationWrapper], board_size=5)
register(id="SimpleTak-v0-large", entry_point="textarena.envs.games.SimpleTak.env:SimpleTakEnv", default_wrappers=[LLMObservationWrapper], board_size=6)
register(id="SimpleTak-v0-extra-large", entry_point="textarena.envs.games.SimpleTak.env:SimpleTakEnv", default_wrappers=[LLMObservationWrapper], board_size=8)
...
register(id="SimpleNegotiation-v0", entry_point="textarena.envs.games.SimpleNegotiation.env:SimpleNegotiationEnv", default_wrappers=[LLMObservationWrapper], max_turns=10)
register(id="SimpleNegotiation-v0-short", entry_point="textarena.envs.games.SimpleNegotiation.env:SimpleNegotiationEnv", default_wrappers=[LLMObservationWrapper], max_turns=6)
register(id="SimpleNegotiation-v0-long", entry_point="textarena.envs.games.SimpleNegotiation.env:SimpleNegotiationEnv", default_wrappers=[LLMObservationWrapper], max_turns=30)
